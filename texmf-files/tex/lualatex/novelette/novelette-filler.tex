%% This is file `novelette-filler.tex', part of `novelette' document class.
%% Copyright 2024 Robert Allgeyer.
%%
%% This file may be distributed and/or modified under the
%% conditions of the LaTeX Project Public License, version 1.3c.
%% The literary content of this file is in the Public Domain. See below.
%%
\ProvidesFile{novelette-filler.tex}%
[2024/01/18 v0.35 LaTeX file (filler text).]
%%


%% This file is only loaded when processing interior (not cover).


%% FILLER TEXT
%% ----------------------------------------------------------------------------
% Novelette does not load the `lipsum' package, or `blindtext'.
% If you need filler text, command \fillertext inserts the following text.
% It may only be used in shade mode. Any other mode issues an error.
%   The text is heavily edited from `The Decay of the Art of Lying'
% by American author Mark Twain (Samuel Clemens), 1835-1910.
%   Due to passage of time since the death of its author,
% it is in the Public Domain of the United States of America,
% and of nations that agree to the Berne Copyright Convention.
% Other nations may have different laws regarding Public Domain.
%   The plain text was obtained from a well-known online free text site,
% which discourages use of its name in re-distributed files.
%   Edits were made in the interest of modern usage.
%%
...
same degree, is an injurious truth. Lying is universal: we \ital{all} do it.
...
\endinput
%%
%% End of file `novelette-filler.tex'.

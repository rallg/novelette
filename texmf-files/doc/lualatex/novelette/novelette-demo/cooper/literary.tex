...
\edit{a popular}{an American} novelist of the \edit{American }{}pioneer era.}
\end{upperpage}

% The initial T is enlarged. An automatic kern is applied, so that the visible
% gap between T and the following letter is reduced. Only applies to T.
\init{T}[here are rules] governing literary art in romantic fiction.
...
6. They require that when the author describes the character of \edit{a}{some}
...
graduate in the \edit{beginning}{start} of a paragraph, he shall not talk
...
11. They require that \edit{}{all of }the characters in a tale shall be so
...
and he was never so happy as when he \edit{was working }{worked }these
innocent things.
...
Cooper was a sailor---a naval officer; yet he gravely tells\edit{ us}{} how
...
which will hold\edit{ her}{} back against the gale and save her. For just pure
...
splendidly inaccurate. Cooper seldom saw anything correctly.
He \edit{saw}{observed}
...
for music he will flat and sharp\edit{ right}{} along without knowing it.

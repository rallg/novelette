...
% If you compile just this file, blank pages will be added.
% This is because pageiii knows that it has two pages before it.
...
\null\null\null\null\null % blank lines.
\begin{blockindent}[4,4] % Better serveral short lines, than few long ones.
...
% Blank page vi will be inserted automatically by \mainmatter.

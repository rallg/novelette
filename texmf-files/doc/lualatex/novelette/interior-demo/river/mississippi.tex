...
% \hist invokes historical (Latin) characters for IVXLCDM.
% In Swainson, the historical characters occupy standard utf8 code points.
% Note that this does not convert Arabic to Latin numerals. It does not count.
% All it does is slightly change the shape of these characters.
\scene{\hist{I}. As a River}
...
fifty-four subordinate rivers \edit{that are }{}navigable by steamboats,
and from some hundreds \edit{that are}{}navigable by flats and keels.
...
a mile. At the junction of the Ohio the \edit{Mississippi's}{river's} depth is
...
is always \edit{changing its habitat \ital{bodily}---is always }{}
...
\edit{not yet in her teens;}{a young girl;}
\ital{Don Quixote} was not yet written; Shakespeare was not yet born;
\edit{}{and }a hundred long years must
...
\edit{that amount of}{much} curiosity. The Mississippi was left unvisited by

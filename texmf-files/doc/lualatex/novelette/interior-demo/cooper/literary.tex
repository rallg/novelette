...
\init{T\sk{-1.3}}[here are rules] governing literary art in romantic fiction.
...
For\icon{2.3} several years Cooper was daily in the society of artillery,
...
\image[float=n,align=l]{1}

\icon[wide,align=c]{10}

Cooper's proudest\icon{2.3} creations in the way of ``situations'' suffer
